...
void clear_screen(BYTE screen, BOOL stripe) {
    ...
    for (i = 0; i < 32; i++) {
		...
		0 + (stripe ? (1 - i % 2 << CFSFT_PALETTE) : 0));
    }
}
void gameover(){
    clear_screen(SCREEN2, FALSE);
    draw_string(SCREEN2, 8, 7, FONT_FREE, " Game Over");
...
void end_level() {
	clear_screen(SCREEN2, FALSE);
    draw_string(SCREEN2, 8, 7, FONT_FREE, " Level End!");
	clear_screen(SCREEN1, TRUE);
    display_control(DCM_SCR1 | DCM_SCR2 | DCM_SCR2_WIN_INSIDE | DCM_SPR);
}

void mapscrolling(int level, int screenscrolling){
	if (level == 1){
		if (screenscrolling == 0){
				...
				mapload(0, 13, "00000000000000000000000000000000");
				mapload(0, 14, "00000000000000000000000000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				mapload(0, 16, "00000000000000000000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
			}
				...
				mapload(0, 14, "00000000222200000002222000000000");
				mapload(0, 15, "00000000222200000002222000000000");
				mapload(0, 16, "00000000222200000002222000000000");
				mapload(0, 17, "00000000222200000002222000000000");
			}
			...
			if (screenscrolling == 0){
				mapload(0, 0 , "00002200000002200000000000000000");
				mapload(0, 1 , "00002200000002200000000000000000");
				mapload(0, 2 , "00002200000002200000000000000000");
				mapload(0, 3 , "00002200000002200000000000000000");
				mapload(0, 4 , "00002200000000000000000000000000");
				mapload(0, 5 , "00002200000000000000000000000000");
				mapload(0, 6 , "00000000022000000000000002222222");
				mapload(0, 7 , "00000000022000000000000002222222");
				mapload(0, 8 , "00000000022000000000000000022222");
				mapload(0, 9 , "00000000022000000000000000022222");
				mapload(0, 10, "22222222222000000000000000002222");
				mapload(0, 11, "22222222222000000000000000000022");
				mapload(0, 12, "22222222222000000000000000000000");
				mapload(0, 13, "22222222222000000000000000000000");
				mapload(0, 14, "00000000000000000000000000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				mapload(0, 16, "00000000000000000000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
				...
				mapload(0, 0 , "00000000000000000022000000000000");
				mapload(0, 1 , "00000000000000000022000000000000");
				mapload(0, 2 , "00000000000000000022000000000000");
				mapload(0, 3 , "00000000000000000022000000000000");
				mapload(0, 4 , "00000000000000000022000000000000");
				mapload(0, 5 , "00000000000000000022000000000000");
				mapload(0, 6 , "22222222220000000022000000000000");
				mapload(0, 7 , "22222222220000000022000000000000");
				mapload(0, 8 , "22222222220000000022220000000000");
				mapload(0, 9 , "22222222220000000022220000000000");
				mapload(0, 10, "22222222220000000000000000000000");
				mapload(0, 11, "00000000000000000000000000000022");
				mapload(0, 12, "00000000000000000000000000000000");
				mapload(0, 13, "00000000000000000000000000000000");
				mapload(0, 14, "22222220000000000000220000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				mapload(0, 16, "00000000000000000000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
			}
				...
				mapload(0, 2 , "00000000000000000000000000000000");
				mapload(0, 3 , "00000000000000000000000000000000");
				mapload(0, 4 , "00000000000000000000002222222222");
				mapload(0, 5 , "00000000000000222000002222222222");
				mapload(0, 6 , "00000000000000000000000000000000");
				mapload(0, 7 , "00000000000000000000000000000000");
				mapload(0, 8 , "00000022200000000000000000000000");
				mapload(0, 9 , "00000000000000000000000000000000");
				mapload(0, 10, "00000000000000000000000000000000");
				mapload(0, 11, "22220000000000000000000000000000");
				mapload(0, 12, "00000000000022222222222222222222");
				mapload(0, 13, "00000000000000222222222222222222");
				mapload(0, 14, "00000000000000000222222222222222");
				mapload(0, 15, "00000000000000000002222000000000");
				mapload(0, 16, "00000000000000000002222000000000");
				mapload(0, 17, "00000000000000000002222000000000");
			}
			else if (screenscrolling == 3){
				mapload(0, 0 , "00000000000022000000000000000000");
				mapload(0, 1 , "00000000000022000000000000000000");
				mapload(0, 2 , "00000000000000000000000000000000");
				mapload(0, 3 , "00000000000000000000000000000000");
				mapload(0, 4 , "22222222222220000000000002222000");
				mapload(0, 5 , "22222222222220000000000000022222");
				mapload(0, 6 , "22222222222220000000000000000222");
				mapload(0, 7 , "00000000000220000000000000000022");
				mapload(0, 8 , "00000000000220000000000000000000");
				mapload(0, 9 , "00000000000220000000000000000000");
				mapload(0, 10, "00000000000220000000000000000000");
				mapload(0, 11, "00000000000220000000000000000000");
				mapload(0, 12, "22220000000220000000000000000000");
				mapload(0, 13, "22220000000000000000000000000000");
				mapload(0, 14, "00000000000000000000000000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				mapload(0, 16, "00000000000000000000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
				...
				mapload(0, 0 , "00000000000000000000000000220002");
				mapload(0, 1 , "00000000000000000000000000220002");
				mapload(0, 2 , "00000000000000000000000000220002");
				mapload(0, 3 , "00000000000000000000000000220002");
				mapload(0, 4 , "00000000000000000000000000220002");
				mapload(0, 5 , "22222200000000000000022000000002");
				mapload(0, 6 , "22222200000000000000022000000002");
				mapload(0, 7 , "00000200000220000000022000220002");
				mapload(0, 8 , "00000200000220000000022000220002");
				mapload(0, 9 , "00000000000000002200000000220002");
				mapload(0, 10, "00000000000000002200000000220002");
				mapload(0, 11, "22200000000000000000000000220000");
				mapload(0, 12, "22200000000000000002200000220000");
				mapload(0, 13, "00000000000000000002200000000002");
				mapload(0, 14, "00000000000022000000000000000002");
				mapload(0, 15, "00002200000022000000000000000002");
				mapload(0, 16, "00002200000000000000000000000002");
				mapload(0, 17, "00000000000000000000000000000002");
			}
			else if (screenscrolling == 5){
				mapload(0, 0 , "00000000000000000000000000000000");
				mapload(0, 1 , "00200202220000200000000000000000");
				mapload(0, 2 , "00200202002002220000000000000000");
				mapload(0, 3 , "00200202220022222000000000000000");
				mapload(0, 4 , "00200202000000200000000000000000");
				mapload(0, 5 , "00022002000000200000000000000000");
				mapload(0, 6 , "00000000000000000000000000000000");
				mapload(0, 7 , "00000000000000000000000000000000");
				mapload(0, 8 , "00000000000000000000000000000000");
				mapload(0, 9 , "00000000000000000000000000000000");
				...
				mapload(0, 11, "00000000000000000000000000000000");
				mapload(0, 12, "00000000000000000000000000000000");
				mapload(0, 13, "22222222222220000000000000000000");
				mapload(0, 14, "22222222222220000000000000000000");
				mapload(0, 15, "22222220000000000000000000000000");
				mapload(0, 16, "22222220000000000000000000000000");
				mapload(0, 17, "22222220000000000000000000000000");
			}
			else if (screenscrolling == 6){
				mapload(0, 0 , "00000000000000000000000000220000");
				mapload(0, 1 , "00000000000000000000000000220000");
				mapload(0, 2 , "00000000000000000000000000220000");
				mapload(0, 3 , "00000000000000000000000000220000");
				mapload(0, 4 , "00000000000000000000000000220000");
				mapload(0, 5 , "00000000000000000000000000220000");
				mapload(0, 6 , "00000000000000000000000000220000");
				mapload(0, 7 , "00000000000000000000000000220000");
				mapload(0, 8 , "00000000000000000220000222220000");
				mapload(0, 9 , "00000000000000000220000000000000");
				mapload(0, 10, "00000000000000000220000000000000");
				mapload(0, 11, "00000000000000000220000000000000");
				mapload(0, 12, "00000000000222222220000000222222");
				mapload(0, 13, "00000000000222222220000000222222");
				mapload(0, 14, "00000000000222222220000000222222");
				mapload(0, 15, "00000000000222222220000000222222");
				mapload(0, 16, "00000000000222222220000000222222");
				mapload(0, 17, "00000000000222222220000000222222");
			}
			else if (screenscrolling == 7){
				level++;
				screenscrolling = 0;
			...
			if (screenscrolling == 0){
				mapload(0, 0 , "00000000022000000000000220000000");
				mapload(0, 1 , "00000000022000000000000220000000");
				mapload(0, 2 , "00000000022000000000000220000000");
				mapload(0, 3 , "00000000022000000000000220000000");
				mapload(0, 4 , "00000000022000000000000220000000");
				mapload(0, 5 , "00000000022000022220000000000000");
				mapload(0, 6 , "00000000022000000220000000000000");
				mapload(0, 7 , "00000000022000000220000000000000");
				mapload(0, 8 , "00000000022000000220000000000000");
				mapload(0, 9 , "00000000022000000000000000222222");
				mapload(0, 10, "00000002222000000000000000002222");
				mapload(0, 11, "00000000000000000000000000000000");
				mapload(0, 12, "00000000000000000000000000000000");
				mapload(0, 13, "22222000000000000000000000000000");
				mapload(0, 14, "22222000000000000000000000000000");
				mapload(0, 15, "22222000000000220000000000000000");
				mapload(0, 16, "22222000000000000000000000000000");
				mapload(0, 17, "22222000000000000000000000000000");
			}
			else if (screenscrolling == 1){
				mapload(0, 0 , "00000022000000222220000000220000");
				mapload(0, 1 , "00000022000000222220000000220000");
				mapload(0, 2 , "00000022000000222220000000220000");
				mapload(0, 3 , "00000022000000002000000000220000");
				mapload(0, 4 , "00000022000000002000000000220000");
				mapload(0, 5 , "00000022000000002000000000220000");
				mapload(0, 6 , "00000022000220000000000000220000");
				mapload(0, 7 , "00000000000220000000000000020000");
				mapload(0, 8 , "00000000000200000000000000020000");
				mapload(0, 9 , "00000000000200000000000000020000");
				mapload(0, 10, "22222220000200000000022200020000");
				mapload(0, 11, "00000000000000000022222200000000");
				mapload(0, 12, "00000000000000022222222200000000");
				mapload(0, 13, "00000000000000000000000000000000");
				mapload(0, 14, "00000000000000000000000000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				mapload(0, 16, "00000000000000002222222200000000");
				mapload(0, 17, "00000000000000000000000000000000");
			}
			else if (screenscrolling == 2){
				mapload(0, 0 , "00000000000000000000222000000000");
				mapload(0, 1 , "00000000000000000000222000000000");
				mapload(0, 2 , "00000000000000000000222000000000");
				mapload(0, 3 , "00000000000000000000222000000000");
				mapload(0, 4 , "00000000000000000000222000000000");
				mapload(0, 5 , "00000000000000000000222000000000");
				mapload(0, 6 , "00000000000000000000222000000000");
				mapload(0, 7 , "00000000000000000000222000000000");
				mapload(0, 8 , "00000000222222200000000000000000");
				mapload(0, 9 , "00000000222222200000000000000000");
				mapload(0, 10, "00000000220000000000000000000000");
				mapload(0, 11, "00000000220000000000000000000000");
				mapload(0, 12, "00000000000000000000000000000000");
				mapload(0, 13, "00000000000000000000000000000000");
				mapload(0, 14, "00000000000000000000000000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				...
				mapload(0, 0 , "00000000000000000002200000000000");
				mapload(0, 1 , "00000000000000000002200000000000");
				mapload(0, 2 , "00000000000000000002200000000000");
				mapload(0, 3 , "00000000000000220002200000000000");
				mapload(0, 4 , "00002222200000220002200000222222");
				mapload(0, 5 , "00002200000000000002200000022222");
				mapload(0, 6 , "00002200000000000002200000022222");
				mapload(0, 7 , "00002200000000000002200000022222");
				mapload(0, 8 , "00002200000000000002200000022222");
				mapload(0, 9 , "00002200000000000002200000022222");
				mapload(0, 10, "00002200000000000000000000022222");
				mapload(0, 11, "00000000000000000000000000022222");
				mapload(0, 12, "00000000000000000000000000000000");
				mapload(0, 13, "00000000000000220000000000000000");
				mapload(0, 14, "00000000000000220000000000000000");
				mapload(0, 15, "00000000000000000000000000000000");
				mapload(0, 16, "00000000000000000000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
			}
			else if (screenscrolling == 4){
				mapload(0, 0 , "22222222000000000000000000000000");
				mapload(0, 1 , "22222222000000000000000000000000");
				mapload(0, 2 , "00000000000000000000000000000000");
				mapload(0, 3 , "00000000000000000000000000000000");
				mapload(0, 4 , "22222222000000000000000000000000");
				mapload(0, 5 , "22222222000000000002222222222222");
				mapload(0, 6 , "00000000000000000002222222222222");
				mapload(0, 7 , "00000000000000000000022222222222");
				mapload(0, 8 , "00000000000000000000000222222222");
				mapload(0, 9 , "00000220000000000000000000000000");
				mapload(0, 10, "00000220000000000000000000000000");
				mapload(0, 11, "22222220000000000000000000000000");
				mapload(0, 12, "22220000000000000000000000000000");
				mapload(0, 13, "00000000000000000000000000000000");
				mapload(0, 14, "00000000000000000000000000000000");
				mapload(0, 15, "00000000000002200000000000000000");
				mapload(0, 16, "00000000000002200000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
			}
			else if (screenscrolling == 5){
				mapload(0, 0 , "00000220000000000000000000000000");
				mapload(0, 1 , "00000220000000000000000000000000");
				mapload(0, 2 , "00000220000000000000000000000000");
				mapload(0, 3 , "00000000000000000000022000000000");
				mapload(0, 4 , "00000000000000220000022000000000");
				mapload(0, 5 , "22222222000000220000022000000000");
				mapload(0, 6 , "22222222000000000000022000000000");
				mapload(0, 7 , "00000000000000000000000000022222");
				mapload(0, 8 , "00000000000000000000000000022222");
				mapload(0, 9 , "00000000000000000000000000000000");
				mapload(0, 10, "22220000000000000000000000000000");
				mapload(0, 11, "22220000000000000000000000000000");
				mapload(0, 12, "22200000000000000000000000000000");
				mapload(0, 13, "22200000000000000000000000000000");
				mapload(0, 14, "22200000000000000000000000000000");
				mapload(0, 15, "22200000000000000000000000000000");
				mapload(0, 16, "22200000000000000000000000000000");
				mapload(0, 17, "22200000000000000000000000000000");
			}
			else if (screenscrolling == 6){
				mapload(0, 0 , "00000000000000000000000000000000");
				mapload(0, 1 , "00000000000000000000000000000000");
				mapload(0, 2 , "00000000000000000000000000000000");
				mapload(0, 3 , "00000000000000000000000000000000");
				mapload(0, 4 , "00000000000000222000000000000000");
				mapload(0, 5 , "00000000000002222200000000000022");
				mapload(0, 6 , "00000000000000020000000002222222");
				mapload(0, 7 , "22200000000000020000000002000002");
				mapload(0, 8 , "22220000000000020000000002000002");
				mapload(0, 9 , "22220000000000020000000002000002");
				mapload(0, 10, "22220000000000000000000002000002");
				mapload(0, 11, "22220000000000000000000002000002");
				mapload(0, 12, "22220000000000000000000002000002");
				mapload(0, 13, "22200000000000000000000002000002");
				mapload(0, 14, "00000000000000000000000002000002");
				mapload(0, 15, "00000000000000000000000002000002");
				mapload(0, 16, "00000000000000000000000002000002");
				mapload(0, 17, "00000000000000000000000002000002");
			}
			else if (screenscrolling == 7){
				screenscrolling = 0;
			}
...
BOOL pause() {
    clear_screen(SCREEN2, FALSE);
    draw_string(SCREEN2, 10, 7, FONT_FREE    , " PAUSE");
    draw_string(SCREEN2, 6, 9, FONT_FREE + 6 , " START: Exit");
    draw_string(SCREEN2, 6, 10,FONT_FREE + 18, " OTHER: Unpause");
    display_control(DCM_SCR1 | DCM_SCR2 | DCM_SCR2_WIN_INSIDE | DCM_SPR);
...
BOOL play(int level) {
	...
	lunge, lunge_lag, lunge_anim, guard_anim, iJmp, iChn, iChn1, iChn2, iChn3, screenscrolling, Phealth;
	BYTE x, y, x2, y2;
	BYTE loop;
	WORD key_data;
	init_sprite();
	...
	Phealth = 6;
	screenscrolling = 0;
	i = 0; /* Variable for incrementing the sprite cycle. Essentially tracks the progress of the current sprite cycle. */
	...
	do {
		...
		if(iJmp==0){	
			...
			if((iChn==0)&&(iChn1==0)&(jump_height_potential==0)) /* If player is off the ground and no longer rising from a Jump, gravity is in effect */
			{
				y = y + 2;
		...
		if ((iChn != 0) || (iChn1 != 0) || (iChn2 != 0) || (iChn3 != 0)) {
			sound_set_volume(0, 0);
		}
		...
		if (key_data & KEY_LEFT1){
			...
			if ((key_data & KEY_B) != TRUE){
				...
				if ((iChn == 0) & (l_momentum == 1) & (current_ability != 4) && (iChn3==0)&&(x>0)){ /* If player is in air and has momentum, they maintain high speed */
					x = x - 1;
				}
			}
		}
		...
		if (key_data & KEY_RIGHT1){
			...
			if ((key_data & KEY_B) != TRUE){
				...
				if ((iChn == 0) & (r_momentum==1) & (current_ability != 4) && (iChn2==0)){ /* If player is in air and has momentum, they maintain high speed */
					x = x + 1;
				}
			}
		}
		...
		mapscrolling(level, screenscrolling);
		if (y > 200){
			Phealth = 0;
		}
		if (screenscrolling == 7) {
			end_level();
			sys_wait(100);
			key_data = 'end';
			break;
...
void y_controls_guide() {
	...
	clear_screen(SCREEN1, TRUE);
	draw_string(SCREEN1, 0, 1 , FONT_FREE      , " Y-CONTROLS (ABILITIES)");
	draw_string(SCREEN1, 0, 4 , FONT_FREE + 23 , " Y1 - Hover: Low gravity,");
	draw_string(SCREEN1, 0, 5 , FONT_FREE + 48 , " high lateral air movement");
	draw_string(SCREEN1, 0, 7 , FONT_FREE + 74 , " Y2 - Lunge: Instantly move");
	draw_string(SCREEN1, 0, 8 , FONT_FREE + 102 , " to either left or right");
	draw_string(SCREEN1, 0, 10, FONT_FREE + 126, " Y3 - Time Slow: Halve the");
	draw_string(SCREEN1, 0, 11, FONT_FREE + 152, " passage of time for easy");
	draw_string(SCREEN1, 0, 12, FONT_FREE + 177, " movements");
	draw_string(SCREEN1, 0, 14, FONT_FREE + 187, " Y4 - Slide: Run instead of");
	draw_string(SCREEN1, 0, 15, FONT_FREE + 214, " Walk, and after a while,");
	draw_string(SCREEN1, 0, 16, FONT_FREE + 239, " Slide and jump high");
...
void level_menu() {
	...
	display_control(DCM_SCR1);
	clear_screen(SCREEN1, TRUE);
	draw_string(SCREEN1, 4, 4 , FONT_FREE     , " Y1: Level 1");
	draw_string(SCREEN1, 4, 7 , FONT_FREE + 12, " Y2: Level 2");
	draw_string(SCREEN1, 4, 10, FONT_FREE + 24, " Y3: Level 3");
	draw_string(SCREEN1, 4, 13, FONT_FREE + 36, " OTHER: Exit");
...
int main_menu() {
	...
	display_control(DCM_SCR1);
	clear_screen(SCREEN1, TRUE);
	draw_string(SCREEN1, 4, 4 , FONT_FREE     , " START: Levels");
	draw_string(SCREEN1, 4, 7 , FONT_FREE + 14, " A: Controls Guide");
	draw_string(SCREEN1, 4, 10, FONT_FREE + 32, " B: Information");
	draw_string(SCREEN1, 4, 13, FONT_FREE + 47, " OTHER: Exit");
...
int start_menu() {
    ...
    display_control(DCM_SCR1);
    draw_title(SCREEN1);
    draw_string(SCREEN1, 6, 15, FONT_FREE, " PRESS ANY KEY");

...
void clear_screen(BYTE screen, BOOL stripe) {
    ...
    for (i = 0; i < 32; i++) {
		...
		FONT_FREE + (stripe ? (1 - i % 2 << CFSFT_PALETTE) : 0));
    }
}
void gameover(){
    clear_screen(SCREEN2, FALSE);
    draw_string(SCREEN2, 11, 7, 0, "Game Over");
...
if (screenscrolling == 0){
			...
			if (screenscrolling == 0){
				mapload(0, 0 , "00002222222222222222222222222222");
				mapload(0, 1 , "00002222222222222222222222222222");
				...
				mapload(0, 8 , "00000000022000000000000000000000");
				mapload(0, 9 , "00000000022000000000000000000000");
				mapload(0, 10, "22222222222000000000000000000000");
				mapload(0, 11, "22222222222000000000000000000000");
				mapload(0, 12, "22222222222000000000000000000000");
				mapload(0, 13, "22222222222000000000000000000000");
				mapload(0, 14, "22222222222000000000000000000000");
				mapload(0, 15, "22222222222000000000000000000000");
				mapload(0, 16, "22222222222000000000000000000000");
				mapload(0, 17, "22222222222000000000000000000000");
			}
			else if (screenscrolling == 1){
				mapload(0, 0 , "22222220000000000022220000000000");
				mapload(0, 1 , "22222200000000000022220000000000");
				mapload(0, 2 , "00000000000000000022220000000000");
				mapload(0, 3 , "00000000000000000022220000000000");
				mapload(0, 4 , "00000000000000000022220000000000");
				mapload(0, 5 , "00000000000000000022220000000000");
				mapload(0, 6 , "22222222220000000022220000000000");
				mapload(0, 7 , "22222222220000000022220000000000");
				...
				mapload(0, 0 , "00000000000022222000000000000000");
				mapload(0, 1 , "00000000000000000000000000000000");
				mapload(0, 2 , "00000000000000000000002222222222");
				mapload(0, 3 , "00000022200000222000002222222222");
				mapload(0, 4 , "00000000000000000000002222222222");
				mapload(0, 5 , "00000000000000000000002222222222");
				mapload(0, 6 , "00000000000000000000000000000000");
				mapload(0, 7 , "00000000000000000000000000000000");
				mapload(0, 8 , "00000000000000000000000000000000");
				mapload(0, 9 , "00000000000000000000000000000000");
				...
				mapload(0, 15, "00000000000000000002222222222222");
				mapload(0, 16, "00000000000000000002222222222222");
				mapload(0, 17, "00000000000000000002222222222222");
			}
			else if (screenscrolling == 3){
				mapload(0, 0 , "00000000000000000000000000000000");
				mapload(0, 1 , "00000000000000000000000000000000");
				mapload(0, 2 , "22222200000000000000000220000000");
				mapload(0, 3 , "00000022222222000000000002200000");
				mapload(0, 4 , "00000000000020000000000000022000");
				mapload(0, 5 , "00000000000020000000000000000222");
				mapload(0, 6 , "00000000000020000000000000000000");
				mapload(0, 7 , "00000000000020000000000000000000");
				mapload(0, 8 , "00000000000020000000000000000000");
				mapload(0, 9 , "00000000000020000000000000000000");
				mapload(0, 10, "00000000000020000000000000000000");
				mapload(0, 11, "00000000000020000000000000000000");
				mapload(0, 12, "22000000000020000000000000000000");
				mapload(0, 13, "00000000000000000000000000000000");
				...
				mapload(0, 0 , "00000000000000000000000000000002");
				mapload(0, 1 , "00000000000000000000000000020002");
				mapload(0, 2 , "00000000000000000000000000020002");
				mapload(0, 3 , "00000000000002200000000000020002");
				mapload(0, 4 , "00000000000000000000000000020002");
				mapload(0, 5 , "22222200000000000000020000000002");
				mapload(0, 6 , "00000200000000000000020000000002");
				mapload(0, 7 , "00000200000220000000020000020002");
				mapload(0, 8 , "00000200000000000000020000020002");
				mapload(0, 9 , "00000000000000002200000000020002");
				mapload(0, 10, "00000000000000000000000000020002");
				mapload(0, 11, "22200000000000000000000000020000");
				mapload(0, 12, "00000000000000000002200000020000");
				mapload(0, 13, "00000000000000000000000000000002");
				mapload(0, 14, "00000000000022000000000000000002");
				mapload(0, 15, "00002200000000000000000000000002");
				mapload(0, 16, "00000000000000000000000002200002");
				mapload(0, 17, "00000000000000000000000000000002");
			}
			else if (screenscrolling == 5){
				mapload(0, 0 , "00000000000000000000000000000000");
				mapload(0, 1 , "00200202220000000000000000000000");
				mapload(0, 2 , "00200202002000000000000000000000");
				mapload(0, 3 , "00200202220000000000000000000000");
				mapload(0, 4 , "00022002000000000000000000000000");
				mapload(0, 5 , "00000000000000000000000000000000");
				mapload(0, 6 , "00000000000000000000000000000000");
				mapload(0, 7 , "00000000000000000000000000000000");
				mapload(0, 8 , "00000000000000000000000000000000");
				...
				mapload(0, 14, "22222220000000000000000000000000");
				...
				mapload(0, 0 , "00000000000000000000000000020000");
				mapload(0, 1 , "00000000000000000000000000020000");
				mapload(0, 2 , "00000000000000000000000000020000");
				mapload(0, 3 , "00000000000000000000000000020000");
				mapload(0, 4 , "00000000000000000000000000020000");
				mapload(0, 5 , "00000000000000000000000000020000");
				mapload(0, 6 , "00000000000000000000000000020000");
				mapload(0, 7 , "00000000000000000000000000020000");
				mapload(0, 8 , "00000000000000000020000222220000");
				mapload(0, 9 , "00000000000000000020000000000000");
				mapload(0, 10, "00000000000000000020000000000000");
				mapload(0, 11, "00000000000000000020000000000000");
				mapload(0, 12, "00000000000222222220000000022222");
				mapload(0, 13, "00000000000222222220000000022222");
				mapload(0, 14, "00000000000222222220000000022222");
				mapload(0, 15, "00000000000222222220000000022222");
				mapload(0, 16, "00000000000222222220000000022222");
				mapload(0, 17, "00000000000222222220000000022222");
			}
			else if (screenscrolling == 7){
				level++;
			}
			...
			if (screenscrolling == 0){
				mapload(0, 0 , "00000000002200000000000022000000");
				mapload(0, 1 , "00000000002200000000000022000000");
				mapload(0, 2 , "00000000002200000000000022000000");
				mapload(0, 3 , "00000000002200000000000022000000");
				mapload(0, 4 , "00000000002200000000000022000000");
				mapload(0, 5 , "00000000002200002222000000000000");
				mapload(0, 6 , "00000000002200000022000000000000");
				mapload(0, 7 , "00000000002200000022000000000000");
				mapload(0, 8 , "00000000002200000022000000000000");
				mapload(0, 9 , "00000000002200000000000000000022");
				mapload(0, 10, "00000000222200000000000000000000");
				mapload(0, 11, "00000000000000000000000000000000");
				mapload(0, 12, "00000000000000000000000000000000");
				mapload(0, 13, "22222200000000000000000000000000");
				mapload(0, 14, "22222200000000000000000000000000");
				mapload(0, 15, "22222200000000220000000000000000");
				mapload(0, 16, "22222200000000000000000000000000");
				mapload(0, 17, "22222200000000000000000000000000");
			}
			else if (screenscrolling == 1){
				mapload(0, 0 , "00000022000000222000000000220000");
				mapload(0, 1 , "00000022000000222000000000220000");
				mapload(0, 2 , "00000022000000222000000000220000");
				mapload(0, 3 , "00000022000000222000000000220000");
				...
				mapload(0, 9 , "22222220000200000000000200020000");
				mapload(0, 10, "00000000000200000000022200020000");
				...
				mapload(0, 0 , "00000000000000000000200000000000");
				mapload(0, 1 , "00000000000000000000200000000000");
				mapload(0, 2 , "00000000000000000000200000000000");
				mapload(0, 3 , "00000000000000000000200000000000");
				mapload(0, 4 , "00000000000000000000200000000000");
				mapload(0, 5 , "00000000000000000000200000000000");
				mapload(0, 6 , "00000000000000000000200000000000");
				mapload(0, 7 , "00000000000000000000200000000000");
				...
				mapload(0, 4 , "00002222200000000002200000000022");
				mapload(0, 5 , "00000000000000000002200000000022");
				mapload(0, 6 , "00000000000000000002200000000022");
				mapload(0, 7 , "00000000000000000002200000000022");
				mapload(0, 8 , "00000000000000000002200000000022");
				mapload(0, 9 , "00000000000000000002200000000022");
				mapload(0, 10, "00000000000000000000000000000000");
				mapload(0, 11, "00000000000000000000000000000000");
				mapload(0, 12, "00000000000000000000000000000000");
				...
				mapload(0, 16, "2222000000000000000000000000000");
				mapload(0, 17, "00000000000000000000000000000000");
			}
			else if (screenscrolling == 5){
				mapload(0, 0 , "00000220000000000000000000000000");
				mapload(0, 1 , "00000220000000000000000000220000");
				mapload(0, 2 , "00000220000000002200000000220000");
				mapload(0, 3 , "00000000000000002200000000220000");
				mapload(0, 4 , "00000000000000000000000000220000");
				mapload(0, 5 , "22222222000000000000000000000000");
				mapload(0, 6 , "22222222000000000000000000000000");
				mapload(0, 7 , "00000000000000000000000000000022");
				mapload(0, 8 , "00000000000000000000000000000000");
				mapload(0, 9 , "00000000000000000000000000000000");
				...
				mapload(0, 1 , "00000000000000000000000000000000");
				mapload(0, 2 , "00000000000000000000000000000000");
				mapload(0, 3 , "00000000000000020000000000000000");
				mapload(0, 4 , "00000000000000220000000000000000");
				mapload(0, 5 , "00000000000000000000000000000022");
				mapload(0, 6 , "00000000000000000000000000002222");
				mapload(0, 7 , "22200000000000000000000000000000");
				mapload(0, 8 , "00220000000000000000000000000000");
				mapload(0, 9 , "00000000000000000000000000000000");
				mapload(0, 10, "00000000000000000000000000000000");
				mapload(0, 11, "00000000000000000000000000000000");
				mapload(0, 12, "00000000000000000000000000000000");
...
BOOL play(int level) {
	...
	lunge, lunge_lag, lunge_anim, guard_anim, iJmp, iChn, iChn1, iChn2, iChn3, iChn4, screenscrolling, Phealth;
	BYTE x, y, x2, y2;
	BYTE loop;
	WORD key_data;
	init_sprite();
